...
FROM `dezoomcamp-2026-486917.nytaxi.yellow_tripdata_2024_01-06`;
```
...
SELECT COUNT(DISTINCT PULocationID) AS distinct_pu_location_ids
FROM `dezoomcamp-2026-486917.nytaxi.yellow_tripdata_2024_01-06_ext`;
```
...
```sql
SELECT COUNT(*) AS records_with_fare_amount_0
FROM `dezoomcamp-2026-486917.nytaxi.yellow_tripdata_2024_01-06`
WHERE fare_amount = 0;
```
...
```sql
CREATE OR REPLACE TABLE `dezoomcamp-2026-486917.nytaxi.yellow_tripdata_2024_01-06_opt`
PARTITION BY DATE(tpep_dropoff_datetime)
CLUSTER BY VendorID AS
SELECT * FROM `dezoomcamp-2026-486917.nytaxi.yellow_tripdata_2024_01-06`;
```
...
SELECT DISTINCT(VendorID)
FROM `dezoomcamp-2026-486917.nytaxi.yellow_tripdata_2024_01-06_opt`
WHERE DATE(tpep_dropoff_datetime) BETWEEN '2024-03-01' AND '2024-03-15';
```
...
0 B, because it is metadata-only operation
